...
- **conn_info** (Dict[str, Any]): Connection information for :obj:`psycopg2.connect`.
...
- **records** (List[VectorRecord]): List of vector records to add or update. **kwargs (Any): Additional keyword arguments.
...
- **ids** (List[str]): List of record IDs to delete. **kwargs (Any): Additional keyword arguments.
