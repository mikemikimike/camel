...
<a id="camel.models.mistral_model.MistralModel._map_finish_reason"></a>

### _map_finish_reason

```python
def _map_finish_reason(mistral_reason: str):
```

Map a Mistral finish reason to its OpenAI equivalent.
