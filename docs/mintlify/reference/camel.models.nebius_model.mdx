...
LLM API served by Nebius Token Factory in an OpenAI-compatible
interface.
...
- **api_key** (Optional[str], optional): The API key for authenticating with Nebius Token Factory. (default: :obj:`None`).
- **url** (Optional[str], optional): The URL to Nebius Token Factory. (default: :obj:`None`)
